        ...
        <div className="w-full max-w-md space-y-6">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Automate your Lead Management & Outreach with AI-powered message personalization
            </p>
          </div>
              ...
              <Card className="shadow-sm">
                <CardHeader>
                  ...
                  <CardDescription data-testid="text-register-description">
                    Start automating your Lead Management & Outreach today
                  </CardDescription>
                </CardHeader>
                <CardContent>
